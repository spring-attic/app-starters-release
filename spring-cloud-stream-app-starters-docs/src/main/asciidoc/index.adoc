...
:app-starters-asciidoc: https://raw.githubusercontent.com/spring-cloud-stream-app-starters/app-starters-release/Celsius/spring-cloud-stream-app-starters-docs/src/main/asciidoc
